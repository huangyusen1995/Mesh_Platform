...
//
//	connect(ui->actionMean_Error, SIGNAL(triggered()), this, SLOT(SurfaceMesh *original_mesh, SurfaceMesh *result_mesh));
//
//}
...
//void Mesh_PlatformClass::mean_error(SurfaceMesh *original_mesh, SurfaceMesh *result_mesh)
//{
